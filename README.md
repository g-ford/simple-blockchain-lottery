...
hurl invoke simplelottery simplelottery_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- simplelottery org1
# Install to your blockchain - From the root of your project
hurl install simplelottery node -P ./chaincode-simplelottery
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install simplelottery node -P ./chaincode-simplelottery --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade simplelottery node 1.2 -P ./chaincode-simplelottery
```
